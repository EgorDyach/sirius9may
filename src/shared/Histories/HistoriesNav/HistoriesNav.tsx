    ...
    <div className='histories__nav'>
      <button disabled={isPrevDisabled} onClick={() => { 
        ...
        <svg width="90" height="90" viewBox="0 0 90 90" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M57.7877 62.2125L40.6127 45L57.7877 27.7875L52.5002 22.5L30.0002 45L52.5002 67.5L57.7877 62.2125Z" fill="white" fillOpacity="0.87" />
        </svg>
      </button>
      <button disabled={isNextDisabled} onClick={() => { 
        ...
        <svg width="90" height="90" viewBox="0 0 90 90" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M32.2123 62.2125L49.3873 45L32.2123 27.7875L37.4998 22.5L59.9998 45L37.4998 67.5L32.2123 62.2125Z" fill="white" fillOpacity="0.87" />
        </svg>
      </button>
    </div>
  );
