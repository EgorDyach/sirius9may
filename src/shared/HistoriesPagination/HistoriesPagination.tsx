import './historiespagination.css';
import { useSwiper } from 'swiper/react';
import { Text } from '../../components/Text';
import { useLayoutEffect, useState } from 'react';
export function HistoriesPagination({activeIndex, setActiveIndex}: {activeIndex: number; setActiveIndex: React.Dispatch<React.SetStateAction<number>>}) {
