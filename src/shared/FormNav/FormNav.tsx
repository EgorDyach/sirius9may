...
export function FormNav({mainInfoError, historyError, contactsError, active, setActive }: {mainInfoError: boolean; historyError: boolean; contactsError: boolean; active: number; setActive: React.Dispatch<React.SetStateAction<number>> }) {
  return (
    <ul className="form__nav">
      ...
      <li onClick={() => setActive(0)} className={active === 0 ? "form__nav-item form__nav-active" : "form__nav-item"}>
        <span className={`form__dot ${mainInfoError ? "form__dot-error" : ""}`}></span>
      </li>
      ...
      <li onClick={() => setActive(2)} className={active === 2 ? "form__nav-item form__nav-active" : "form__nav-item"}>
        <span className={`form__dot ${historyError ? "form__dot-error" : ""}`}></span>
      </li>
      ...
      <li onClick={() => setActive(4)} className={active === 4 ? "form__nav-item form__nav-active" : "form__nav-item"}>
        <span className={`form__dot ${contactsError ? "form__dot-error" : ""}`}></span>
      </li>
    </ul>
  );
}
