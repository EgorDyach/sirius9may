  ...
  return (
    <div className="gallary__controls">
      <div className='gallary__nav'>
        <button disabled={activeIndex <= 0} onClick={() => { swiper.slidePrev(); setActiveIndex(activeIndex -4) }} className='swiper-button-prev'>
        ...
        <button disabled={activeIndex >= swiper.slides.length - 1} onClick={() => { swiper.slideNext(); setActiveIndex(activeIndex + 4) }} className='swiper-button-next'>
          <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
