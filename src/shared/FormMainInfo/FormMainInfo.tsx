    ...
    <div className="formMainInfo">
      ...
      <div className="formMainInfo__top">
        <label className="formMainInfo__img">
          ...
          <input disabled={formData.isNoMainPhoto} type="file" accept="image/png, image/jpeg, image/webp, image/jpg, image/jpeg, image/tiff, image/raw, image/gif" onChange={(q) => setFormData(q.target.files ? { ...formData, mainPhoto: q.target.files[0] } : { ...formData, mainPhoto: null })} name="mainPhotoFile" id="mainPhotoFile" />
          <label className="formMainInfo__checkbox-con">
            <input
              onChange={() => setFormData({ ...formData, mainPhoto: null, isNoMainPhoto: !formData.isNoMainPhoto })
              }
